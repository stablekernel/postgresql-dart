      ...
      case PostgreSQLDataType.text:
        {
          ...
          return castBytes(utf8.encode(value as String));
        }
      case PostgreSQLDataType.real:
        {
          ...
          final bd = ByteData(4);
          bd.setFloat32(0, value as double);
          return bd.buffer.asUint8List();
        }
      case PostgreSQLDataType.double:
        {
          ...
          final bd = ByteData(8);
          bd.setFloat64(0, value as double);
          return bd.buffer.asUint8List();
        }
      ...
      case PostgreSQLDataType.timestampWithoutTimezone:
        {
          ...
          final bd = ByteData(8);
          final diff =
              (value as DateTime).toUtc().difference(DateTime.utc(2000));

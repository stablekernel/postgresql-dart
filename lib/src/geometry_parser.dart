...
class PostgisEWKTParser extends PostgisGeometryParser {
  ...
  LineString parseLineString(List<int> ewkt) {
    ...
    if (lineString is LineString) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid LineString. Ensure your format is EWKB & is a LineString');
    }
  }
  ...
  MultiPolygon parseMultiPolygon(List<int> ewkt) {
    ...
    if (multiPolygon is MultiPolygon) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid MultiPolygon. Ensure your format is EWKB & is a MultiPolygon');
    }
  }
  ...
  Point parsePoint(List<int> ewkt) {
    ...
    if (point is Point) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid Point. Ensure your format is EWKB & is a Point');
    }
  }
  ...
  Polygon parsePolygon(List<int> ewkt) {
    ...
    if (point is Polygon) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid Polygon. Ensure your format is EWKB & is a Polygon');
    }
  }
  ...
  GeometryCollection parseGeometryCollection(List<int> ewkt) {
    ...
    if (geometryCollection is GeometryCollection) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid GeometryCollection. Ensure your format is EWKB & is a GeometryCollection');
    }
  }
  ...
  Geometry parseGeometry(List<int> ewkt) {
    ...
    if (geometry is Geometry) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid Geometry. Ensure your format is EWKB & is a Geometry');
    }
  }
  ...
  MultiLineString parseMultiLineString(List<int> ewkt) {
    ...
    if (multiLineString is MultiLineString) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid MultiLineString. Ensure your format is EWKB & is a MultiLineString');
    }
  }
  ...
  MultiPoint parseMultiPoint(List<int> ewkt) {
    ...
    if (multiPoint is MultiPoint) {
      ...
      throw EwkbFormatException(
          '$ewkt is not valid MultiPoint. Ensure your format is EWKB & is a MultiPoint');
    }
  }
